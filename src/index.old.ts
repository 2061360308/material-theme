/**一些旧的方法， 自己实现的比不上 material-color-utilities 的 效果， 所以弃用*/
/** 防止后续需要优化体积，暂时保留*/
...
//     4: this.hslToRgb({
//       h: hsl.h,
//       s: Math.max(hsl.s - 10, 0),
//       l: Math.min(hsl.l + 5, 100),
//     }),
//     5: this.hslToRgb({
//       h: hsl.h,
...
//     "5-5": this.hslToRgb({
//       h: hsl.h,
//       s: Math.max(hsl.s - 20, 0),
//       l: Math.min(hsl.l + 15, 100),
//     }),
//     6: this.hslToRgb({
//       h: hsl.h,
//       s: Math.max(hsl.s - 25, 0),
//       l: Math.min(hsl.l + 20, 100),
//     }),
//   };
...
//   // 生成深色阴影
//   const shadowColors = {
//     "red-3-shadow": this.hslToRgb({
//       h: hsl.h,
//       s: Math.min(hsl.s + 10, 100),
//       l: Math.max(hsl.l - 30, 0),
//     }),
//     "red-6-shadow": this.hslToRgb({
//       h: hsl.h,
//       s: Math.min(hsl.s + 15, 100),
//       l: Math.max(hsl.l - 25, 0),
//     }),
//   };
...
//   const cssVariables = {
//     light: {
//       ...Object.entries(lightVariants).reduce(
//         (acc, [key, color]) => ({
//           ...acc,
...
//         {}
//       ),
//       ...Object.entries(shadowColors).reduce(
//         (acc, [key, color]) => ({
//           ...acc,
...
// async generateMaterialYouColorSchemeFromImage(imageSource: string | HTMLImageElement) {
